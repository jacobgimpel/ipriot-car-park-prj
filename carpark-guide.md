...
| ---------- |--------------------------|----------------------------------------|
| `CarPark`    | Capacity, Available Bays | Show Capacity, Show available bays     |
| `Sensor`     | Location, Occupied Bays  | Increment count, display occupied bays |
| `Display`    | Screen, Content          | Display Content, Display on/off        |
