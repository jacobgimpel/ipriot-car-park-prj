...
class TestCarPark(unittest.TestCase):
    ...
    def test_register_raises_type_error(self):
        self.car_park = CarPark("288 Hector Street", 300)
        test_str = "please_work_i_dont_like_unit_tests"
        with self.assertRaises(TypeError):
            self.car_park.register(test_str)
    ...
    def test_carpark_init_with_config(self):
